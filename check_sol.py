...
## Known sol
c_sol = load_obj('c_sol.pkl')
phi_sol = load_obj('phi_sol.pkl') 
print(phi_sol[100])
### Compute solution
...
#phi.vector().apply("")
#phi.vector()[:] = phi_sol.copy()
#print(phi.vector()[100])
solve(F_phi == L_phi, phi, bcs_phi)
print(phi.vector()[100])
print(norm(np.array(phi.vector()[:] - phi_sol)),'\n')
...
print(norm(np.array(c.vector()[:] - c_sol)),'\n')
