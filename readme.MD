...
Neumann condition  
4) <img src="img/neuman1.png" alt="neuman">
...
5) <img src="img/robin1.png" alt="robin">
#$`-D_{o}\frac{\partial c_{3}}{\partial n} = D_{r}\frac{\partial c_{4}}{\partial n} = c_{3}k_{red} - c_{4}k_{ox}`$  
