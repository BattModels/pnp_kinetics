using Pkg; Pkg.activate("/home/mbabar/PhD/Gerischer/")
loc = "/home/mbabar/PhD/Gerischer/ElectrochemicalKinetics.jl/src/"

using Distributed
using SharedArrays
using ClusterManagers

addprocs(48; exeflags="--project=/home/mbabar/PhD/Gerischer/Project.toml")
...
for η in η_list
    ...
    out_file = matopen(location*"k_data_Vapp_"*string(round(η,digits=2))*".mat", "w")
