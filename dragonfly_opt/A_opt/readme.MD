...
3. Specify the variables to be tuned and their ranges in discrete numerics in `optimize.json`. For this directory `A_opt/`, MHC-prefactor is varied from 0 to 100. 
...
The optimizer finds an accurate MHC-prefactor which fits the sigmoid function within 10 search iterations,
